...
python -m gpt2_dst.scripts.evaluate \
    --input_path_target="${PATH_DIR}"/gpt2_dst/data/v2/furniture_to/furniture_devtest_dials_target.txt \
...
python -m gpt2_dst.scripts.evaluate \
    --input_path_target="${PATH_DIR}"/gpt2_dst/data/v2/furniture/furniture_devtest_dials_target.txt \
...
python -m gpt2_dst.scripts.evaluate \
    --input_path_target="${PATH_DIR}"/gpt2_dst/data/v2/fashion_to/fashion_devtest_dials_target.txt \
...
python -m gpt2_dst.scripts.evaluate \
    --input_path_target="${PATH_DIR}"/gpt2_dst/data/v2/fashion/fashion_devtest_dials_target.txt \
